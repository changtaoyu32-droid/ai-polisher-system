...
export const LOCAL_REPLACEMENTS = [
  ...
  // 4. V4新增：AI高频词深度替换（覆盖更多AI常用表达）
  { pattern: /显著/g, replacements: ["相当明显", "十分突出", "颇为显著"] },
  { pattern: /广泛/g, replacements: ["大面积", "在很大范围内", "相当普遍"] },
  { pattern: /丰富/g, replacements: ["充实多样", "内容充沛", "种类繁多"] },
  { pattern: /确保/g, replacements: ["保证", "切实保障", "力求做到"] },
  { pattern: /旨在/g, replacements: ["目的在于", "意在", "着眼于"] },
  { pattern: /致力于/g, replacements: ["一直专注于", "持续聚焦在", "把精力放在"] },
  { pattern: /鉴于/g, replacements: ["考虑到", "出于", "基于目前的情况"] },
  { pattern: /探讨/g, replacements: ["探究", "深入讨论", "仔细研究"] },
  { pattern: /阐述/g, replacements: ["讲述", "说明", "展开论述"] },
  { pattern: /呈现/g, replacements: ["展示出", "表现出", "显示为"] },
  { pattern: /涵盖/g, replacements: ["覆盖", "包含", "囊括了"] },
  { pattern: /构建/g, replacements: ["搭建", "建立起", "打造"] },
  { pattern: /促进/g, replacements: ["推动", "带动", "助力"] },
  { pattern: /影响/g, replacements: ["左右", "波及", "产生作用"] },
  { pattern: /表明/g, replacements: ["说明", "揭示出", "体现出"] },
  { pattern: /具备/g, replacements: ["拥有", "兼具", "持有"] },
  { pattern: /发挥/g, replacements: ["展现出", "体现出", "充分利用"] },
  { pattern: /深入/g, replacements: ["透彻", "细致", "更进一步"] },
  { pattern: /逐步/g, replacements: ["一步步", "循序渐进地", "慢慢"] },
  { pattern: /充分/g, replacements: ["尽可能", "全方位", "最大限度"] },
  { pattern: /针对/g, replacements: ["面向", "围绕着", "聚焦于"] },
  { pattern: /有助于/g, replacements: ["有利于", "对…有好处", "能够帮助"] },
  { pattern: /关键/g, replacements: ["核心", "至关紧要", "起决定性作用"] },
  { pattern: /因此/g, replacements: ["正因如此", "所以说", "有鉴于此"] },
  { pattern: /然而/g, replacements: ["不过", "可是", "话虽这么说"] },
  { pattern: /此外/g, replacements: ["除此以外", "另外还有一点", "再有就是"] },
  { pattern: /同时/g, replacements: ["与此同时", "在此过程中", "一并"] },
  { pattern: /目前/g, replacements: ["眼下", "就当前情况而言", "截至目前"] },
  { pattern: /由于/g, replacements: ["缘于", "正是因为", "受…的影响"] },
  { pattern: /从而/g, replacements: ["进而", "如此一来", "也就能够"] },
  { pattern: /对于/g, replacements: ["就…而言", "谈到", "在…这个问题上"] },
  { pattern: /不断/g, replacements: ["持续", "一直在", "始终"] },
  { pattern: /有效/g, replacements: ["行之有效", "切实有用", "颇具成效"] },
  { pattern: /相关/g, replacements: ["有关", "相应", "与之关联"] },
  { pattern: /整体/g, replacements: ["总体", "从全局来看", "全盘"] },
  { pattern: /核心/g, replacements: ["中枢", "最关键", "灵魂所在"] },
  { pattern: /明确/g, replacements: ["清晰界定", "明白无误地指出", "厘清"] }
];
